function [prob_mb] = RecursiveSegmentation_release(points,ft_threshold,paral,plot)
%function [BiLabel, BiLabel_Regu,prob_mb] = RecursiveSegmentation_release(points,ft_threshold,paral,plot)
% points: nx3
...
% %MB: below are commented because the process results in an error (index
% %pointing over array size)
